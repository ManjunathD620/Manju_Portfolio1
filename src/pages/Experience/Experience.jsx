...
import NumocityLogo from "@/assets/images/numocity.jpeg";
      ...
      <div className="relative mb-6 flex items-center gap-1">
        ...
        {logo && (
          <img
            src={logo}
            alt={`${company} logo`}
            className="w-[4.5rem] h-[4.5rem] object-cover rounded-full z-10 shadow-md"
...
const ExperienceSection = () => {
  const experiences = [
    ...
    },
    {
      ...
      period: "2021-Present",
      description:
        "Delivered scalable, secure backend systems at Numocity, powering EV infrastructure with Node.js, microservices, and cloud-native solutions across AWS, GCP, and Azure",
      logo: NumocityLogo,
    },
  ];
